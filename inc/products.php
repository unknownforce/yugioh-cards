...
/*****************************************************************************************************
	...
	Pharaoh's Servant CARD SET
	
*****************************************************************************************************/
function get_PSV_cards() {
       // when creating a new product, create it first in PayPal and
    // then copy the product ID from PayPal to use here     
    ...
    try {
        ...
        FROM yugiohcards         
        INNER JOIN sets ON sets.setname=yugiohcards.set
        WHERE sets.setcode='PSV'
        ORDER BY setnumber ASC");
    } catch (Exception $e) {
        echo "All Cards from Pharaoh's Servant could not be retrieved from the database.";
        exit;
    }
...
/*****************************************************************************************************
	...
	Legacy of Darkness CARD SET
	
*****************************************************************************************************/
function get_LOD_cards() {
       // when creating a new product, create it first in PayPal and
    // then copy the product ID from PayPal to use here     
    ...
    try {
        ...
        FROM yugiohcards         
        INNER JOIN sets ON sets.setname=yugiohcards.set
        WHERE sets.setcode='LOD'
        ORDER BY setnumber ASC");
    } catch (Exception $e) {
        echo "All Cards from Legacy of Darkness could not be retrieved from the database.";
        exit;
    }
...
/*****************************************************************************************************
	...
	Labyrinth of Nightmare CARD SET
	
*****************************************************************************************************/
function get_LON_cards() {
       // when creating a new product, create it first in PayPal and
    // then copy the product ID from PayPal to use here     
    ...
    try {
        ...
        FROM yugiohcards         
        INNER JOIN sets ON sets.setname=yugiohcards.set
        WHERE sets.setcode='LON'
        ORDER BY setnumber ASC");
    } catch (Exception $e) {
        echo "All Cards from Labyrinth of Nightmare could not be retrieved from the database.";
        exit;
    }
...
/*****************************************************************************************************
	...
	Pharaonic Guardian CARD SET
	
*****************************************************************************************************/
function get_PGD_cards() {
       // when creating a new product, create it first in PayPal and
    // then copy the product ID from PayPal to use here     
    ...
    try {
        ...
        FROM yugiohcards         
        INNER JOIN sets ON sets.setname=yugiohcards.set
        WHERE sets.setcode='PGD'
        ORDER BY setnumber ASC");
    } catch (Exception $e) {
        echo "All Cards from Pharaonic Guardian could not be retrieved from the database.";
        exit;
    }
